...
public class LoadSmsActionListener implements ActionListener {
	...
	public LoadSmsActionListener(JTextField userField, JTextField passwordField, JTextField ipAddressField, MainWindow mainFrame, ShortMessagesTable smsTable, JButton toTxt, JButton toHtml) {
